...
const inputStyleMappingClasses = {
  small: "DevBookTextField-inputSizeSmall",
  medium: "DevBookTextField-inputSizeMedium",
  large: "DevBookTextField-inputSizeLarge",
  xlarge: "DevBookTextField-inputSizeXLarge",
};

const classes = {
  root: "DevBookTextField-root",
  input: "DevBookTextField-input",
  inputBorder: "DevBookTextField-inputBorder",
};
